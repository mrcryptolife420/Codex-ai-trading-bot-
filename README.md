...
- Event-driven data: `ENABLE_EVENT_DRIVEN_DATA`, `ENABLE_LOCAL_ORDER_BOOK`, `STREAM_TRADE_BUFFER_SIZE`, `STREAM_DEPTH_LEVELS`, `STREAM_DEPTH_SNAPSHOT_LIMIT`, `MAX_DEPTH_EVENT_AGE_MS`, `BINANCE_FUTURES_API_BASE_URL`
...
- Risk guards: `MAX_LOSS_STREAK`, `MAX_SYMBOL_LOSS_STREAK`, `MIN_BOOK_PRESSURE_FOR_ENTRY`, `EXIT_ON_SPREAD_SHOCK_BPS`
